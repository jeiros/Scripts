...
cp /work/je714/phosphoHMR/${cluster}/${run}/${phosptype}/05_Repeat50ns.in .
cp /work/je714/phosphoHMR/${cluster}/${run}/${phosptype}/03_Heat2_${count}_${cluster}.rst .
...
#
#
pbsexec -grace 15 /home/igould/pmemd.cuda_SPFP -O -i 05_Repeat50ns.in -o 05_Prod_${cluster}.phos${phosptype}.${sim}_${run}repeat.out -c 03_Heat2_${count}_${cluster}.rst -p ${prmtop} -r 05_Prod_${cluster}.phos${phosptype}.${sim}_${run}repeat.rst -x 05_Prod_${cluster}.phos${phosptype}.${sim}_${run}repeat.nc
...
tar -zcvf /tmp/pbs.$PBS_JOBID/${run}_${cluster}_${sim}repeat.tgz *
#
#
