...
#
/home/igould/amber/bin/pmemd.cuda_SPFP -O -i premin.in -o premin_${count}_${cluster}.out -c $inpcrd -p $prmtop -r premin_${count}_${cluster}.rst  -ref $inpcrd
#
...
/home/igould/amber/bin/pmemd.cuda_SPFP -O -i sandermin1.in -o sandermin_${count}_${cluster}.out -c premin_${count}_${cluster}.rst -p $prmtop -r sandermin1_${count}_${cluster}.rst
#
...
#
/home/igould/amber/bin/pmemd.cuda_SPFP -O -i 02_Heat.in -o 02_Heat_${count}_${cluster}.out -c sandermin1_${count}_${cluster}.rst -p $prmtop -r 02_Heat_${count}_${cluster}.rst -x 02_Heat_${count}_${cluster}.nc -ref sandermin1_${count}_${cluster}.rst
#
...
#
/home/igould/amber/bin/pmemd.cuda_SPFP -O -i 03_Heat2.in -o 03_Heat2_${count}_${cluster}.out -c 02_Heat_${count}_${cluster}.rst -p $prmtop -r 03_Heat2_${count}_${cluster}.rst -x 03_Heat2_${count}_${cluster}.nc -ref 02_Heat_${count}_${cluster}.rst
#
...
#
#
pbsexec -grace 15 /home/igould/amber/bin/pmemd.cuda_SPFP -O -i 05_Prod.in -o 05_Prod_${cluster}.phos${phosptype}.${sim}_${run}.out -c 03_Heat2_${count}_${cluster}.rst -p $prmtop -r 05_Prod_${cluster}.phos${phosptype}.${sim}_${run}.rst -x 05_Prod_${cluster}.phos${phosptype}.${sim}_${run}.nc
#
#
#
