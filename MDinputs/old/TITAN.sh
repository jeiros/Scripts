...
# This shell script is specific to running jobs on TITAN's which are on host cx1-51-3-1
...
cp /work/igould/howarth4/*.in .
cp /work/igould/howarth4/*.inpcrd .
cp /work/igould/howarth4/*.prmtop .
...
#
/home/igould/cuda5.0pmemd.cuda_SPFP -O -i premin.in -o premin_$count.out -c $inpcrd -p $prmtop -r premin_$count.rst  -ref $inpcrd
#
...
/home/igould/cuda5.0pmemd.cuda_SPFP -O -i sandermin1.in -o sandermin_$count.out -c premin_$count.rst -p $prmtop -r sandermin1_$count.rst
#
...
#
/home/igould/cuda5.0pmemd.cuda_SPFP -O -i 02_Heat.in -o 02_Heat_$count.out -c sandermin1_$count.rst -p $prmtop -r 02_Heat_$count.rst -x 02_Heat_$count.nc -ref sandermin1_$count.rst
#
...
#
/home/igould/cuda5.0pmemd.cuda_SPFP -O -i 03_Heat2.in -o 03_Heat2_$count.out -c 02_Heat_$count.rst -p $prmtop -r 03_Heat2_$count.rst -x 03_Heat2_$count.nc -ref 02_Heat_$count.rst
#
...
#
#
pbsexec -grace 15 /home/igould/cuda5.0pmemd.cuda_SPFP -O -i 05_Prod.in -o 05_Prod_$count.out -c 03_Heat2_$count.rst -p $prmtop -r 05_Prod_$count.rst -x 05_Prod_$count.nc
#
#
#
# tar up everything in the temporary directory
tar -zcvf /tmp/pbs.$PBS_JOBID/howarth4startup.tgz *
#
#
...
cp *tgz /work/igould/howarth4/results
#
#
