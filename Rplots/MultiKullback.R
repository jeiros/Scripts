...
p1 <- ggplot(d1, aes(x = Frame, y = value, colour = variable)) + geom_line() + ylab("PC1") +
  ...
  scale_x_continuous(limits=c(10000,34000))

p2 <- ggplot(d2, aes(x = Frame, y = value, colour = variable)) + geom_line() + ylab("PC2") +
 	scale_color_discrete("") + theme(legend.position = c(1,1), legend.justification = c(1,1),
  legend.background = element_rect(fill = "white", colour = "black")) + scale_y_continuous(limits=c(0,1)) +
  scale_x_continuous(limits=c(10000,34000))

p3 <- ggplot(d3, aes(x = Frame, y = value, colour = variable)) + geom_line() + ylab("PC3") +
 	scale_color_discrete("") + theme(legend.position = c(1,1), legend.justification = c(1,1),
  legend.background = element_rect(fill = "white", colour = "black")) + scale_y_continuous(limits=c(0,1)) +
  scale_x_continuous(limits=c(10000,34000))
